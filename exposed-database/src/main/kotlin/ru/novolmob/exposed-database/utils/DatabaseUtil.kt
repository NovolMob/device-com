package ru.novolmob.`exposed-database`.utils
...
import ru.novolmob.`exposed-database`.tables.*
import ru.novolmob.`exposed-database`.tables.credentials.UserCredentials
